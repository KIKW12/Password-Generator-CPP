...
Es aquí donde nace la idea de crear un generador de contraseñas que se adapte completamente a las carácterísticas necesarias requeridas por el usuario, desde la longitud de esta, si debe de utilizar mayúsculas, caracteres especiales, utilizar números y con esto, poder brintar una capa extra de seguridad al solo utilizar números primos generados de manera "aleatoria".
